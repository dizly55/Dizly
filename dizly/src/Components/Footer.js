      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-6">
        ...
        <div>
          ...
          <p className="text-dizly-text text-sm md:text-base italic tracking-wide leading-relaxed">
            Dizly is your go-to hub for creating, sharing, and discovering <span className="font-semibold text-dizly-teal">dope digital products</span>—where your creativity meets the vibe! ✨
          </p>
        </div>
        ...
        <div>
          ...
          <ul>
            <li className="mb-1 hover:text-dizly-coral cursor-pointer transition-colors">Home</li>
            <li className="mb-1 hover:text-dizly-coral cursor-pointer transition-colors">Blog</li>
            <li className="mb-1 hover:text-dizly-coral cursor-pointer transition-colors">About</li>
            <li className="mb-1 hover:text-dizly-coral cursor-pointer transition-colors">Contact</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="flex gap-3 mb-4 text-dizly-teal text-lg">
            <a href="https://www.instagram.com/yourprofile" target="_blank" className="hover:text-dizly-coral transition-colors">
              Instagram
            </a>
            <a href="https://www.youtube.com/yourchannel" target="_blank" className="hover:text-dizly-coral transition-colors">
              YouTube
            </a>
            <a href="https://www.linkedin.com/in/yourprofile" target="_blank" className="hover:text-dizly-coral transition-colors">
              LinkedIn
            </a>
          </div>
          ...
          <div className="bg-white rounded-2xl p-4 shadow-lg flex flex-col gap-3">
            ...
            <p className="text-dizly-text text-sm">Get the latest digital products and updates straight to your inbox.</p>
